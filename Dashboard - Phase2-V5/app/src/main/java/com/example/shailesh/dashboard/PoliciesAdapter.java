...
import com.example.shailesh.dashboard.Article;
import com.example.shailesh.dashboard.NewsAdapter;
...
public class PoliciesAdapter extends RecyclerView.Adapter<PoliciesAdapter.MyViewHolder> {
    ...
    public PoliciesAdapter(ArrayList<Article> arts, Context context) {
        this.arts = arts;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view;
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.policies_card_view, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        Description_tv.setText(Jsoup.parse(arts.get(position).getDesc()).text());
