...
class QuestionDatabaseHelper extends SQLiteOpenHelper {
    ...
    private void addQuestionsToDatabase() {
        ...
        allQuestions.add(new Question("How do you come to know about this policy?", "Govt. Website", "News Paper", "PharmaConnect App"));
        allQuestions.add(new Question("Do you think this policy will serve the intended purpose? ", "Yes", "No", "May Be"));
        allQuestions.add(new Question(" To what extent, if any, would you say the following policy will have a positive or negative impact on the relationship bet\n" +
                "ween the Government  \n" +
                "and the citizens?", "A lot", "Not much", "I don't know"));
